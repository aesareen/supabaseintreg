...
app = modal.App(image=image, secrets=[secret], volumes={"/mnt/data": volume}, name = 'usage-dashboard-with-supabase')
...
def run():
    ...
    env_vars = {"SUPABASE_KEY": os.getenv("SUPABASE_KEY"), "SUPABASE_URL": os.getenv("SUPABASE_URL") }
